...
class StylePostProcessor(DataPostProcessor):
    SYSTEM_PROMPT = (
        "You are an expert at crafting AI and robot identity descriptions. "
        "You are tasked with styling text to emphasize the technological and artificial nature of the subject. "
        "When styling, ensure the output begins with 'You are' and explicitly acknowledges the AI/robotic nature. "
    )
